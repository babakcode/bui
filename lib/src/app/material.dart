...
/// [BUIMaterialApp] uses this [TextStyle] as its [DefaultTextStyle] to encourage
...
/// Describes which theme will be used by [BUIMaterialApp].
enum ThemeMode {
...
/// [GridPaper].
///
/// [BUIMaterialApp] configures its [WidgetsApp.textStyle] with an ugly red/yellow
...
///
/// The [BUIMaterialApp] configures the top-level [Navigator] to search for routes
...
/// The [BUIMaterialApp] automatically creates a [DefaultSelectionStyle]. It uses
/// the colors in the [ThemeData.textSelectionTheme] if they are not null;
/// otherwise, the [BUIMaterialApp] sets [DefaultSelectionStyle.selectionColor] to
...
///
/// {@tool snippet}
/// This example shows how to create a [BUIMaterialApp] that disables the "debug"
...
///
/// {@tool snippet}
/// This example shows how to create a [BUIMaterialApp] that uses the [routes]
...
///
/// {@tool snippet}
/// This example shows how to create a [BUIMaterialApp] that defines a [theme] that
...
class BUIMaterialApp extends StatefulWidget {
  ...
  /// Creates a [BUIMaterialApp] that uses the [Router] instead of a [Navigator].
  ///
  /// {@macro flutter.widgets.WidgetsApp.router}
  const BUIMaterialApp.router({
    super.key,
    this.scaffoldMessengerKey,
  ...
  ///    and [darkTheme] in [BUIMaterialApp].
  ...
  /// ```
  ///
  /// Constructing a [BUIMaterialApp] with a `FooLocalizationsDelegate` overrides
  ...
  /// {@endtemplate}
  ///
  /// When null, defaults to [BUIMaterialScrollBehavior].
  ///
  /// See also:
  ///
  ...
  @override
  State<BUIMaterialApp> createState() => _BUIMaterialAppState();

  /// The [HeroController] used for Material page transitions.
  ///
  /// Used by the [BUIMaterialApp].
...
/// Describes how [Scrollable] widgets behave for [BUIMaterialApp]s.
///
/// {@macro flutter.widgets.scrollBehavior}
///
/// Setting a [BUIMaterialScrollBehavior] will apply a
...
class BUIMaterialScrollBehavior extends ScrollBehavior {
...
class _BUIMaterialAppState extends State<BUIMaterialApp> {
  ...
  void initState() {
    super.initState();
    _heroController = BUIMaterialApp.createMaterialHeroController();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ScrollConfiguration(
      behavior: widget.scrollBehavior ?? const BUIMaterialScrollBehavior(),
